...
$string['privacy:metadata'] = 'The Autocomplete menu field type plugin doesn\'t store any personal data; it uses tables defined in core.';
$string['specificsettings'] = 'Autocomplete menu field settings';
